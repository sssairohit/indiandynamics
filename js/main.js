...
class ContactFormHandler {
    ...
    showMessage(message, type) {
        ...
        messageEl.style.cssText = `
            ...
            right: 40px;
            padding: 20px 30px;
            background: ${type === 'success' ? 'linear-gradient(135deg, #00d4ff 0%, #7c3aed 100%)' : '#ff6b6b'};
            color: white;
            border-radius: 12px;
            font-weight: 600;
            z-index: 10000;
        ...
        setTimeout(() => {
            messageEl.style.animation = 'slideOutRight 0.5s ease-out';
            setTimeout(() => {
...
class App {
    ...
    initializeComponents() {
        console.log('%c🤖 NexTech Robotics', 'color: #00d4ff; font-size: 24px; font-weight: bold;');
        console.log('%cWebsite initialized successfully!', 'color: #7c3aed; font-size: 14px;');
        ...
        if (window.innerWidth >= 1024) {
            this.components.push(new CursorEffect());
        }
